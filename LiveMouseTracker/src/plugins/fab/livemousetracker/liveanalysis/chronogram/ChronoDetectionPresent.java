...
public class ChronoDetectionPresent extends ChronoFeatureAbstract implements ProcessAnimalSingleFeature {

	public ChronoDetectionPresent() {
		super ( "Detection" , "Detection of..." , TimeLineDataType.BOOLEAN );
	}

	public void process( Animal animal , Integer frameStart, Integer frameEnd )
	{
		System.out.println("processing no detection...");
