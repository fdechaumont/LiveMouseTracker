...
public class ChronoEscape extends ChronoFeatureAbstract implements ProcessAnimalPairFeature {

	public ChronoEscape() {
		super ( "Escape" , "Mouse A Speed > Mouse B Speed & Mouse A getting away from B" , TimeLineDataType.BOOLEAN );
	}
...
//		description += " and " + animalA.getName() + " is getting away from " + animalB.getName();
