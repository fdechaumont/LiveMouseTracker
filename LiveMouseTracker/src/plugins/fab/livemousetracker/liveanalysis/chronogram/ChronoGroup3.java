...
/**
 * @deprecated > moved to processdatabase
 * @author Fab
 *
 */
public class ChronoGroup3 extends ChronoFeatureAbstract implements ProcessAnimalGroupFeature {

	HashMap<Integer, DetectAtT> detectMap;
	HashMap<Integer, ROI2DArea> detectMergeMap = new HashMap<Integer, ROI2DArea>();

	public ChronoGroup3() {
		super ( "Group3" , "All mice are together but 1"
				+ "All mice are together but 1" , TimeLineDataType.BOOLEAN );
	}
