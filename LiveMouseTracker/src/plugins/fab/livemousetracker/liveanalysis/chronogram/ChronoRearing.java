...
public class ChronoRearing extends ChronoFeatureAbstract implements ProcessAnimalSingleFeature {

	public ChronoRearing() {
		super ( "Rearing" , "Rearing of..." , TimeLineDataType.BOOLEAN );
	}

	public void process( Animal animal , Integer frameStart, Integer frameEnd )
	{
//		System.out.println("processing rearing detection...");
		description = "Rearing detection of " + animal.getName();
