...
import plugins.fab.livemousetracker.morpho.MomentMesure;
import plugins.fab.livemousetracker.morpho.MomentParameter;
...
public class Moment {
	...
	public Moment( ArrayList<Point> pointList ) { //, IcyBufferedImage seq ) {

		Point[] ptsCc = new Point[pointList.size()];
		for ( int i = 0 ; i < pointList.size() ; i++ )
		{
			ptsCc[i] = pointList.get( i );
		}
