...
public class Overlay3DStef extends Overlay
{

    Rendering3DStef renderer = null;
    int channelControl = 0;

    public Overlay3DStef(Rendering3DStef renderer)
    {
        super("Overlay3D");
    ...
    public void paint(Graphics2D g, Sequence sequence, IcyCanvas canvas)
    {
        ...
        for (Channel3DStef channel : renderer.channelArray)
        {
            if (channel.enabled)
            {
